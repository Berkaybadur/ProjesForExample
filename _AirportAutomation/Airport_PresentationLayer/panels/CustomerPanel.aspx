<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerPanel.aspx.cs" Inherits="Airport_PresentationLayer.panels.CustomerPanel" %>
...
<head runat="server">
    ...
    <link rel="icon" type="image/png" href="../icons/userpanel.png" />
...
<body class="user-profile">
    <form id="formCustomer" runat="server">
        <div class="wrapper ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 pr-1">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtCustomerId" type="text" class="form-control" disabled="" runat="server" placeholder="CustomerId" value="CustomerId"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-4 px-1">
                                            <div class="form-group">
                                                <label>Müşteri Tc</label>
                                                <asp:TextBox ID="txtCustomerTc" type="text" class="form-control" runat="server" placeholder="CustomerTc"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-4 pl-1">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Email </label>
                                                <asp:TextBox ID="txtCustomerMail" type="email" class="form-control" runat="server" placeholder="Email address"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 pr-1">
                                            <div class="form-group">
                                                <label>Ad</label>
                                                <asp:TextBox ID="txtCustomerName" type="text" class="form-control" runat="server" placeholder="First Name"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-4 px-1">
                                            <div class="form-group">
                                                <label>Soyad</label>
                                                <asp:TextBox ID="txtCustomerSurname" type="text" class="form-control" runat="server" placeholder="Last Name"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-4 pl-1">
                                            <div class="form-group">
                                                <label>Derece</label>
                                                <asp:DropDownList ID="ddlDegree" runat="server" type="text" class="form-control" value="City"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 pr-1">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtUsername" type="text" class="form-control" runat="server" placeholder="Username"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-4 px-1">
                                            <div class="form-group">
                                                <label>Şifre</label>
                                                <asp:TextBox ID="txtPassword" type="text" class="form-control" runat="server" placeholder="Password"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-4 pl-1">
                                            <div class="form-group">
                                                <label>Şehir</label>
                                                <asp:DropDownList ID="ddlDistrict" runat="server" type="text" class="form-control" value="City"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card card-plain">
                                                <div class="card-header">
                                                    <h4 class="card-title">Table on Customer</h4>
                                                </div>
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <asp:GridView ID="dgwCustomer" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="mGrid">
                                                            <AlternatingRowStyle BackColor="White" />
                                                            <Columns>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <a class="düzenle" href='CustomerPanel.aspx?id=<%#Eval("CustomerId")%>'>Düzenle
                                                                        </a>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
