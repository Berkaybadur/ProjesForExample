<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AirplanePanel.aspx.cs" Inherits="Airport_PresentationLayer.panels.AirplanePanel" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Airplane Panel</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="title">Edit Airplane</h5>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                <label>Uçak Id</label>
                                                <asp:TextBox ID="txtAirplaneId" type="text" class="form-control" disabled="" runat="server" placeholder="AirplaneId" value="AirplaneId"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-6 pl-1">
                                            <div class="form-group">
                                                <label>Uçak Kapasitesi</label>
                                                <asp:TextBox ID="txtSeatingCapacity" type="text" class="form-control" runat="server" placeholder="SeatingCapacity"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                <label>Uçak Ad</label>
                                                <asp:TextBox ID="txtAirplaneName" type="text" class="form-control" runat="server" placeholder="AirplaneName"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-6 pl-1">
                                            <div class="form-group">
                                                <label>Havaalanı</label>
                                                <asp:DropDownList ID="ddlAirportId" runat="server" type="text" class="form-control" value="Havaalanı"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-plain">
                                            <div class="card-header">
                                                <h4 class="card-title">Table on Airplane</h4>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <asp:GridView ID="dgwAirplane" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="mGrid">
                                                        <AlternatingRowStyle BackColor="White" />
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <a class="düzenle" href='AirplanePanel.aspx?id=<%#Eval("AirplaneId")%>'>Düzenle
                                                                    </a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
